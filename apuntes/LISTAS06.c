...
// Se define una funcion que incializa la lista como una lista vacia y recibe por parametro un elemento tipo LISTA
...
// Recibe como parametro un elemento del tipo LISTA y 3 valores que son los que se agregarian
